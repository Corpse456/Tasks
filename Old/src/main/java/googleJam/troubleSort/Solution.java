...
First pass:inspect 5 6 6, do nothing: 5 6 6 4 3inspect 6 6 4, see that 6 > 4, reverse the triplet: 5 4 6 6 3inspect 6 6 3, see that 6 > 3, reverse the triplet: 5 4 3 6 6Second pass:inspect 5 4 3, see that 5 > 3, reverse the triplet: 3 4 5 6 6inspect 4 5 6, do nothing: 3 4 5 6 6inspect 5 6 6, do nothing: 3 4 5 6 6Then the third pass inspects the three triplets and does nothing, so the algorithm terminates.
...
Input 
Output 
 2 5 5 6 8 4 3 3 8 9 7 Case #1: OK Case #2: 1 
...
public class Solution {
    ...
    public static void main (String[] args) throws FileNotFoundException {
        ...
        Scanner in = new Scanner(new BufferedReader(new FileReader("trouble.txt")));
        int t = in.nextInt(); 
